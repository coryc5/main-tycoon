...
/***/ function(module, exports, __webpack_require__) {
	...
	var outputView = __webpack_require__(1);
	var stringHandler = __webpack_require__(2);
	var cssHighlight = __webpack_require__(4);
	var gui = __webpack_require__(5);
	
	var $ = __webpack_require__(3);
	var createGUI = __webpack_require__(5);
	var selFunc = undefined;
	var highlight = undefined;
	
	var trgElem = '#api-window';
	            ...
	            $('#guiSelector').submit(function (e) {
	              ...
	              $.ajax({
	                ...
	                success: function success(data) {
	                  ...
	                  $('#api-window').remove();
	                  $('#window-container').append('<iframe id="api-window" class="container" width="100%" height="900px" src="goodbye.html" name="iframe_a"></iframe>');
	                  setTimeout(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function genOutput(target) {
	  ...
	  var adjStr = stringHandler.adjustStr(target);
	
	  function inner(option) {
	    var att = $('#guiDropDown').val() || '';
	    var txt = att === 'text';
	    var name = $('#propName').val();
	    var result = {};
	    result[name] = [];
	
	    $(trgElem).contents().find(adjStr(option)).each(function (index, elem) {
	      if (txt) {
...
/***/ function(module, exports) {
	...
	function strParse(str) {
	  ...
	  var retStr = '';
	  jqArr.forEach(function (element) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function cssHighlight() {
	  ...
	  function inner(elem, option) {
	    ...
	    if (option === 'clear') {
	      return history.forEach(function (val) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function buildDropDown(str) {
	  ...
	  var jqueryString = "$('#api-window').contents().find('" + str + "')";
